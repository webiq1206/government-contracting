...
export function tierColor(tier: string | null | undefined): string {
  switch (tier) {
    case "pursue": return "bg-pursue/15 text-pursue";
    case "review": return "bg-review/15 text-review";
    case "dismiss": return "bg-dismiss/15 text-slate-400";
    default: return "bg-ink-700 text-slate-300";
  }
}
