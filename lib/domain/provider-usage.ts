...
const SOURCE_LABEL: Record<CredentialSource, string> = {
  platform: "Our connected API service",
  own_key: "Your own AI provider key",
...
const SOURCE_EXPLANATION: Record<CredentialSource, string> = {
  platform: "Any API usage generated by your account will be added to your bill. View charges or change your API source in Settings, API Usage.",
  own_key:
    "Calls are billed to your own provider account (Anthropic or OpenAI). Credit and rate limits are set there.",
  granted:
