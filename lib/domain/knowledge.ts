...
export const WORKFLOW_STEPS: WorkflowStep[] = [
  ...
  },
  {
    ...
    next: "Pursue-tier work starts analysis on its own. Review-tier work gets a Bid Brief, then waits on Today and in the Review Queue.",
  ...
  },
  {
    ...
    trigger: { kind: "schedule", agent: "solicitation-analyst", queuedBy: "an opportunity being scored as pursue or review" },
    ...
    recovery:
      "A brief that reads thin usually means an attachment could not be read. The opportunity's documents section says which file, and re-running analysis from the opportunity picks up a replacement. A scored record with no brief is re-queued within about fifteen minutes.",
    recoveryHref: "/agents",
    recoveryLabel: "Open Automation Health",
    evidence: "analyzed",
    settings: [],
