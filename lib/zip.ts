 ...
 * PDFs/text, so skipping compression costs nothing meaningful.
 *
 * Implements the PKZIP APPNOTE local-file-header + central-directory format
 * with correct CRC-32s, so the archive is well-formed.
 */
