                    ...
                    <li key={tok.key} className="px-2.5 py-2">
                      <div className="flex flex-wrap items-center gap-2">
                        <button
                          ...
                          /* min-h-11 on touch: these are click-to-insert
                          ...
                          className="inline-flex coarse:min-h-11 cursor-grab items-center rounded border border-accent/30 bg-accent-soft px-2 py-1 font-mono text-[11px] text-accent-strong transition hover:border-accent hover:bg-accent/10 active:cursor-grabbing"
                        >
                          {`{{${tok.key}}}`}
                        </button>
                        ...
                        <button
                          ...
                          className="ml-auto inline-flex coarse:min-h-11 coarse:min-w-11 items-center justify-end text-[11px] text-muted-foreground underline-offset-2 hover:text-foreground hover:underline"
                        >
