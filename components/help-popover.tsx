    ...
    <div className="relative inline-block shrink-0" ref={ref}>
      ...
      {open && (
        <div
          ...
          className={`fixed inset-x-4 top-16 z-[70] max-h-[calc(100dvh-8.25rem-env(safe-area-inset-bottom))] w-auto overflow-y-auto overscroll-contain rounded-lg border border-border bg-background p-4 shadow-xl lg:absolute lg:inset-x-auto lg:top-8 lg:max-h-none lg:w-80 lg:overflow-visible ${
