  ...
  return (
    ...
    >
      <button
        ...
        className="rounded px-1 text-slate-400 hover:bg-surface hover:text-accent"
        onClick={(e) => {
          e.stopPropagation();
          if (!open) {
      ...
      {open && (
        <>
          ...
          <span
            ...
            className="absolute right-0 top-6 z-50 block w-72 rounded-lg border border-border bg-white p-3 text-left shadow-lg"
            onClick={(e) => e.stopPropagation()}
            onKeyDown={(e) => {
