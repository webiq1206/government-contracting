...
beforeAll(async()=>{
 ...
 create table communications(id text,org_id text,subcontractor_id text,channel text,direction text,subject text,body text,created_at timestamptz,recipient_email text,gmail_thread_id text,gmail_message_id text,rfc822_message_id text,opportunity_id text,meta jsonb);
