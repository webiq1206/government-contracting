...
export const DEFAULT_TEMPLATES: SeedTemplate[] = [
  {
    ...
    body: [
      ...
      "{{questions}}",
      "",
      "If this is something your team handles, please reply with your price (include payment terms and any exclusions). I'd also like to set up a quick call if it's a fit.",
      "",
      "{{sender_name}}",
      "{{company_name}}",
    ].join("\n"),
