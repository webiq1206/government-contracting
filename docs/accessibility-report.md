...
Measured in Chromium at three widths and in both themes, on rendered output: one pass signed out over the pages a customer meets before they have an account, then one signed in over the operator pages.
...
6 signed-out and 26 signed-in routes x 3 widths x 2 themes. **0 findings.**
