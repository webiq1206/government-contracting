      ...
      <PageFrame
        ...
        <div className="hidden gap-1 rounded-md border border-border p-0.5 sm:flex">
          ...
          <Link
            ...
            className={`inline-flex coarse:min-h-11 items-center rounded px-3 py-2 text-xs px-2.5 py-1 ${view === "lanes" ? "bg-accent-soft font-medium text-accent-strong" : "text-slate-500 hover:text-foreground"}`}
          >
            Simple
          </Link>
          <Link
            href="/pipeline?view=list"
            className={`inline-flex coarse:min-h-11 items-center rounded px-3 py-2 text-xs px-2.5 py-1 ${view === "list" ? "bg-accent-soft font-medium text-accent-strong" : "text-slate-500 hover:text-foreground"}`}
          >
            List
          </Link>
          <Link
            href="/pipeline?view=stages"
            className={`inline-flex coarse:min-h-11 items-center rounded px-3 py-2 text-xs px-2.5 py-1 ${view === "stages" ? "bg-accent-soft font-medium text-accent-strong" : "text-slate-500 hover:text-foreground"}`}
          >
            All stages
          </Link>
          <Link
            href="/pipeline?view=table"
            className={`inline-flex coarse:min-h-11 items-center rounded px-3 py-2 text-xs px-2.5 py-1 ${view === "table" ? "bg-accent-soft font-medium text-accent-strong" : "text-slate-500 hover:text-foreground"}`}
          >
            Table
          </Link>
        </div>
